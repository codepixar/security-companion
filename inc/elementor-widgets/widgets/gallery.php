...
class Security_Gallery extends Widget_Base {
	...
	public function get_title() {
		return __( 'Gallery', 'security-companion' );
	}
	...
	protected function _register_controls() {
        ...
        $this->start_controls_section(
            'gallery_heading',
            [
                'label' => __( 'Gallery Section Heading', 'security-companion' ),
            ]
        );
        $this->add_control(
            'sect_title', [
		...
		$this->start_controls_section(
			'gallery_content',
			[
				'label' => __( 'Gallery', 'security-companion' ),
			]
		);
        $this->add_control(
            'gallery', [
                'label' => __( 'Create gallery', 'security-companion' ),
