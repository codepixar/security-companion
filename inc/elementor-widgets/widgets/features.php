...
class Security_Features extends Widget_Base {
	...
	public function get_title() {
		return __( 'Features', 'security-companion' );
	}
	...
	protected function _register_controls() {
        ...
        $this->start_controls_section(
            'features_heading',
            [
                'label' => __( 'Features Section Heading', 'security-companion' ),
            ]
        );
        $this->add_control(
            'sect_title', [
        ...
        $this->start_controls_section(
            'features_content',
            [
                'label' => __( 'Features', 'security-companion' ),
            ]
        );
        $this->add_control(
            'features', [
                'label' => __( 'Create Features', 'security-companion' ),
                ...
                'fields' => [
                    ...
                    [
                        'name' => 'fonticon',
                        'label' => __( 'Font Icon', 'security-companion' ),
                        'type' => Controls_Manager::ICON,
                    ],
                    [
                        'name' => 'desc',
                        'label' => __( 'Descriptions', 'security-companion' ),
        ...
        $this->start_controls_section(
            'style_features', [
                'label' => __( 'Style Features', 'security-companion' ),
                'tab'   => Controls_Manager::TAB_STYLE,
            ]
        );
        $this->add_control(
            ...
            [
                'label'     => __( 'Style Features Title ', 'security-companion' ),
        ...
        $this->add_control(
            ...
            [
                'label'     => __( 'Style Font Icon', 'security-companion' ),
                'type'      => \Elementor\Controls_Manager::HEADING,
                'separator' => 'before',
            ]
        );
        $this->add_control(
            'color_fonticon', [
                'label'     => __( 'Font Icon Color', 'security-companion' ),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            ...
            [
                'label'     => __( 'Style Descriptions', 'security-companion' ),
                'type'      => \Elementor\Controls_Manager::HEADING,
                'separator' => 'before',
            ]
        );
        $this->add_control(
            'color_desc', [
                'label'     => __( 'Descriptions Color', 'security-companion' ),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
		...
		$this->start_controls_section(
			'style_featuresbox', [
				'label' => __( 'Style Features Box', 'security-companion' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			]
		);
        $this->add_control(
            'featuresbox_bgcolor',
            [
                'label'     => __( 'Style Features Box Background Color', 'security-companion' ),
                'type'      => \Elementor\Controls_Manager::HEADING,
                'separator' => 'before',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label'     => __( 'Style Hover Features Box Background Color ', 'security-companion' ),
                'type'      => \Elementor\Controls_Manager::HEADING,
                'separator' => 'before',
            ]
        );
