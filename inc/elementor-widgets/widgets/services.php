...
class Security_Services extends Widget_Base {
	...
	public function get_title() {
		return __( 'Services', 'security-companion' );
	}
	...
	protected function _register_controls() {
        ...
        $this->start_controls_section(
            'services_heading',
            [
                'label' => __( 'Services Section Heading', 'security-companion' ),
            ]
        );
        $this->add_control(
            'sect_title', [
		...
		$this->start_controls_section(
			'services_block',
			[
				'label' => __( 'Services', 'security-companion' ),
			]
		);
		$this->add_control(
            'services_content', [
                'label' => __( 'Create Service', 'security-companion' ),
                ...
                'fields' => [
                    ...
                    [
                        'name'  => 'url',
                        'label' => __( 'Title Url', 'security-companion' ),
        ...
        $this->start_controls_section(
            'style_servicesbox', [
                'label' => __( 'Style Services Box', 'security-companion' ),
                'tab'   => Controls_Manager::TAB_STYLE,
            ]
        );
        $this->add_control(
        ...
        $this->add_control(
            'servicesbox_bgcolor',
            [
                'label'     => __( 'Style Service Box Background Color', 'security-companion' ),
        ...
        $this->add_control(
            ...
            [
                'label'     => __( 'Style Hover Service Box Background Color ', 'security-companion' ),
                'type'      => \Elementor\Controls_Manager::HEADING,
                'separator' => 'before',
            ]
        );
