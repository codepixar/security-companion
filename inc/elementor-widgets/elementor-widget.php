...
if ( !class_exists( 'Security_El_Widgets' ) ) {
    ...
    final class Security_El_Widgets {
        ...
        public function __clone() {
            ...
            _doing_it_wrong( __FUNCTION__, esc_html__( 'Cheatin&#8217; huh?', 'security-companion' ), '1.7.0' );
        }
        ...
        public function admin_notice_missing_main_plugin() {
            ...
            /* translators: 1: Elementor */
                esc_html__( '"%1$s" requires "%2$s" to be installed and activated.', 'security-companion' ),
                '<strong>' . esc_html__( 'Security Theme', 'security-companion' ) . '</strong>',
                '<strong>' . esc_html__( 'Elementor', 'security-companion' ) . '</strong>'
            );
        ...
        public function admin_notice_minimum_elementor_version() {
            ...
            /* translators: 1: Elementor 2: Required Elementor version */
                esc_html__( '"%1$s" requires "%2$s" version %3$s or greater.', 'security-companion' ),
                '<strong>' . esc_html__( 'Security', 'security-companion' ) . '</strong>',
                '<strong>' . esc_html__( 'Elementor', 'security-companion' ) . '</strong>',
        ...
        public function admin_notice_minimum_php_version() {
            ...
            /* translators: 1: PHP 2: Required PHP version */
                esc_html__( '"%1$s" requires "%2$s" version %3$s or greater.', 'security-companion' ),
                '<strong>' . esc_html__( 'Security', 'security-companion' ) . '</strong>',
                '<strong>' . esc_html__( 'PHP', 'security-companion' ) . '</strong>',
        ...
        public function add_elementor_category() {
            ...
            \Elementor\Plugin::instance()->elements_manager->add_category( 'security-elements', [
                'title' => __( 'Security Elements', 'security-companion' ),
            ], 1 );
        ...
        public function enqueue_element_widgets_scripts() {
            ...
            ******************/
            ...
            wp_register_script( 'security-map-custom', plugins_url( 'assets/js/map-custom.js', __FILE__ ), array('jquery'), '1.0', true );
            ...
            wp_enqueue_script( 'security-companion', plugins_url( 'assets/js/security-companion-main.js', __FILE__ ), array('jquery'), '1.0', true );
        ...
        public function register_widget_styles() {
            // Typing Effect
            wp_enqueue_style( 'security-companion-elementor-edit', plugins_url( '/assets/css/elementor-edit.css', __FILE__ ) );
        }
