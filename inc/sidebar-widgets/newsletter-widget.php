...
esc_html__( '[ Security ] Newsletter Form', 'security-companion' ), 

// Widget description
array( 'description' => esc_html__( 'Add footer newsletter signup form.', 'security-companion' ), ) 
);
...
<div id="mc_embed_signup" class="security-subscribe-newsletter">
	<form target="_blank" novalidate action="<?php echo esc_url( $actionurl ); ?>" id="mc-embedded-subscribe-form" method="post" class="form-inline">
		<input type="email" name="EMAIL" placeholder="<?php esc_html_e( 'Email address', 'security-companion' ); ?>" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Email address'" required>
...
if ( isset( $instance[ 'title' ] ) ) {
	...
	$title = esc_html__( 'Newsletter', 'security-companion' );
}
...
<p>
<label for="<?php echo esc_attr( $this->get_field_id( 'actionurl' ) ); ?>"><?php esc_html_e( 'Action URL:' ,'security-companion'); ?></label> 
