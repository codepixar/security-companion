...
esc_html__( '[ Security ] Social Widget', 'security-companion' ),

// Widget description
array( 'description' => esc_html__( 'Add social content', 'security-companion' ), ) 
);
...
if ( isset( $instance[ 'title' ] ) ) {
	...
	$title = esc_html__( 'Follow Us', 'security-companion' );
}
